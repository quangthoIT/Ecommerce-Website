  ...
  const features = [
    {
      title: "Sofa",
      price: "$200",
      image: "../../assets/Features/product1.png",
    },
    {
      title: "Swivel Chair",
      status: "New",
      price: "$190",
      image: "../../assets/Features/product2.png",
    },
    {
      title: "Chair",
      status: "Sales",
      price: "$175",
      image: "../../assets/Features/product3.png",
      originalPrice: "$225",
    },
    {
      ...
      status: "New",
      price: "$130",
      image: "../../assets/Features/product4.png",
    },
    {
      title: "Woven Chair",
      status: "New",
      price: "$245",
      image: "../../assets/Features/product5.png",
    },
    {
      title: "Armchair",
      status: "Sales",
